    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <p
              className={`text-sm text-white/50 ${isPrivateMode ? "discrete-blur" : ""}`}
            >
        ...
        >
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center ${
              isPrivateMode ? "bg-accent-purple/20" : "bg-white/10"
            }`}
          >
            {isPrivateMode ? (
          ...
          <div
            className={`w-12 h-6 rounded-full transition-colors ${
              isPrivateMode ? "bg-accent-purple" : "bg-white/20"
            }`}
          >
            <div
              className={`w-5 h-5 rounded-full bg-white shadow transition-transform mt-0.5 ${
                isPrivateMode ? "translate-x-6 ml-0.5" : "translate-x-0.5"
              }`}
            />
          </div>
        </button>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-white/50">
            Seus dados continuarão salvos e você poderá fazer login novamente a
            qualquer momento.
          </p>
